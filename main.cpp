...
int main()
{
    ...
    cnn_autoenc_layer1.init_in_from_outside = 0;///When init_in_from_outside = 1 then Lx_IN_convolution_cube is same poiner as the Lx_OUT_convolution_cube of the previous layer
    ...
    CIFAR_object.insert_L1_IN_convolution_cube = cnn_autoenc_layer1.Lx_IN_convolution_cube;///Copy over Mat pointer so CIFAR input image could be load into cnn_autoenc_layer1.Lx_IN_convolution_cube memory.
    ...
    cnn_autoenc_layer2.init_in_from_outside       = 1;///When init_in_from_outside = 1 then Lx_IN_convolution_cube is same poiner as the Lx_OUT_convolution_cube of the previous layer
    ...
    cv::imshow("L2 IN cube", cnn_autoenc_layer2.Lx_IN_convolution_cube);///If no pooling is used between L1-L2 This should be EXACT same image as previous OUT cube layer "Lx OUT cube"
